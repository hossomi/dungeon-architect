...
describe('geometry', () => {
  ...
  describe('getViewCells', () => {
    ...
    it('view = 2x cell; offset = 0.2x cell', () => {
    ...
    it('view = 2x cell; offset = 0.5x cell', () => {
      expect(getViewCells(50, 25, 100, 50, 25, 12.5))
        .toElementsEqualWith([
          new Cell(0, 0).withPosition(0, 25, 50, 25),
          new Cell(0, 1).withPosition(50, 25, 50, 25),
          new Cell(1, 0).withPosition(0, 50, 50, 25),
          new Cell(1, 1).withPosition(50, 50, 50, 25)
        ], Cell.equals);
    });

    it('view = 2x cell; offset = 1x cell', () => {
      expect(getViewCells(50, 25, 100, 50, 50, 25))
        .toElementsEqualWith([
          new Cell(0, 0).withPosition(-25, -2.5, 50, 25),
          new Cell(0, 1).withPosition(25, -2.5, 50, 25),
          new Cell(0, 2).withPosition(75, -2.5, 50, 25),
          new Cell(1, 0).withPosition(-25, 22.5, 50, 25),
          new Cell(1, 1).withPosition(25, 22.5, 50, 25),
          new Cell(1, 2).withPosition(75, 22.5, 50, 25),
          new Cell(2, 0).withPosition(-25, 47.5, 50, 25),
          new Cell(2, 1).withPosition(25, 47.5, 50, 25),
          new Cell(2, 2).withPosition(75, 47.5, 50, 25)
        ], Cell.equals);
    });
  });

  fdescribe('getViewCellsRange', () => {
    it('view = 1; offset = 0', () => {
      expect(getViewCellsRange(100, 80, 100, 80))
        .toEqual({
          rows: { min: 0, max: 0, count: 1 },
          cols: { min: 0, max: 0, count: 1 }
        });
    });

    it('view = 1.25; offset = 0', () => {
      expect(getViewCellsRange(100, 80, 125, 100))
        .toEqual({
    ...
    it('view = 1.5; offset = 0', () => {
      expect(getViewCellsRange(100, 80, 150, 120))
        .toEqual({
          rows: { min: -1, max: 1, count: 3 },
          cols: { min: -1, max: 1, count: 3 }
        });
    ...
    it('view = 1.75; offset = 0', () => {
      expect(getViewCellsRange(100, 80, 175, 140))
        .toEqual({
          rows: { min: -1, max: 1, count: 3 },
          cols: { min: -1, max: 1, count: 3 }
        });
    ...
    it('view = 2; offset = 0', () => {
      expect(getViewCellsRange(100, 80, 200, 160))
        .toEqual({
          rows: { min: -1, max: 1, count: 3 },
          cols: { min: -1, max: 1, count: 3 }
        });
    ...
    it('view = 2.25; offset = 0', () => {
      expect(getViewCellsRange(100, 80, 225, 180))
        .toEqual({
          rows: { min: -1, max: 1, count: 3 },
          cols: { min: -1, max: 1, count: 3 }
        });
    ...
    it('view = 2.5; offset = 0', () => {
      expect(getViewCellsRange(100, 80, 250, 200))
        .toEqual({
          rows: { min: -1, max: 1, count: 3 },
          cols: { min: -1, max: 1, count: 3 }
        });
    ...
    it('view = 2.75; offset = 0', () => {
      expect(getViewCellsRange(100, 80, 275, 220))
        .toEqual({
          rows: { min: -1, max: 1, count: 3 },
          cols: { min: -1, max: 1, count: 3 }
        });
    ...
    it('view = 3; offset = 0', () => {
      expect(getViewCellsRange(100, 80, 300, 240))
        .toEqual({
          rows: { min: -1, max: 1, count: 3 },
          cols: { min: -1, max: 1, count: 3 }
        });
    ...
    it('view = 3.25; offset = 0', () => {
      expect(getViewCellsRange(100, 80, 325, 260))
        .toEqual({
          rows: { min: -2, max: 2, count: 5 },
          cols: { min: -2, max: 2, count: 5 }
        });
    });

    it('view = 1; offset = 0.25', () => {
      expect(getViewCellsRange(100, 80, 100, 80, 25, 20))
        .toEqual({
    ...
    it('view = 2; offset = 0.25', () => {
      expect(getViewCellsRange(100, 80, 200, 160, 25, 20))
        .toEqual({
          rows: { min: -1, max: 1, count: 3 },
          cols: { min: -1, max: 1, count: 3 }
        });
