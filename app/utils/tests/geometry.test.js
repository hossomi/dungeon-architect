...
describe('geometry', () => {
  describe('gridRowPoints', () => {
    it('even grid should work', () => {
      expect(gridRowPoints(25, 100)).toEqual([
        {
    ...
    it('odd grid should work', () => {
      expect(gridRowPoints(20, 100)).toEqual([
        {
    ...
    it('offset < grid should work', () => {
      expect(gridRowPoints(25, 100, 10)).toEqual([
        {
    ...
    it('offset > grid should work', () => {
      expect(gridRowPoints(25, 100, 60)).toEqual([
        {
          view: { start: -15, end: 10, middle: -2.5 },
          grid: { index: -5 }
        },
    ...
    it('offset > view should work', () => {
      expect(gridRowPoints(25, 100, 120)).toEqual([
        {
  ...
  describe('gridPoints', () => {
    it('even steps should work', () => {
      expect(gridPoints(50, 25, 100, 50)).toEqual([
        {
    ...
    it('odd steps should work', () => {
      expect(gridPoints(60, 30, 100, 50)).toEqual([
        {
    ...
    it('offset < grid should work', () => {
      expect(gridPoints(50, 25, 100, 50, 10, 10)).toEqual([
        {
    ...
    it('offset > grid should work', () => {
      expect(gridPoints(50, 25, 100, 50, 60, 30)).toEqual([
        {
    ...
    it('offset > view should work', () => {
      expect(gridPoints(50, 25, 100, 50, 120, 60)).toEqual([
        {
